...
public class AxisSigner {
    ...
    public static final String AXIS_SIGNATURE_FILENAME = "D:/Projects/JAVA/santuario-java/src/test/resources/axisSignature.xml";
    ...
    public static void main(String unused[]) throws Exception {
        ...
        String keystoreFile = "D:/Projects/JAVA/santuario-java/privatestore.jks";
        String keystorePass = "keyStorePassword";
        String privateKeyAlias = "myAlias";
        String privateKeyPass = "keyStorePassword";
